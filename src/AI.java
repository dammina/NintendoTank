...
//	 		   System.out.print("|"+i+"<->"+(i+1)+"|");
	 	   ...
	 	   if(i+10<100 && !WizardGame.blocked.contains(i) && !WizardGame.blocked.contains(i+10)){
	 		  Edge ed1=new Edge(i+"",nodes.get(i), nodes.get(i+10),1);
	 		  edges.add(ed1);
	 		  Edge ed2=new Edge(i+"", nodes.get(i+10), nodes.get(i), 1);
	 		  edges.add(ed2);
//	 		  System.out.print("|"+i+"<->"+(i+10)+"|");
	    ...
	    for(int i=0;i<WizardGame.coins.size();i++){	
	    	...
	    	coin_location=WizardGame.coins.get(i).getX()*10+WizardGame.coins.get(i).getY();
...
//	    	}*/
	    ...
	    else if(path!=null && Integer.parseInt((path.get(1).toString()))%10>y)
